...
public enum Cities {
    //Değişme ihitmali olmayan data tipleri icin kullanılır. (Gün , ay isimleri gibi..)

    //Değişmez bazı yapıları enum yapısında depolayabilirz (Türkiyedeki il isimleri, plaka kodları, postakodları gibi)

    //Değişmez olan yapılar büyük harfle yazilir.
    ...
    //sag tıkla generate ve getter sec asagıdaki olusur
