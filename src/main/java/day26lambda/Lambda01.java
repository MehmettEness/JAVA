...
import java.util.stream.Collectors;
    ...
    public class Lambda01 {
        ...
        public static void printElementsExceptStartsWithE( List<String> myList){
            ...
            //t-> System.out.print(t+" ") bu yazoıyordu biz utils de kısayolunu olusturduk o yüzden oradan cekeceğiz
            // once utils olusturup print kısmını olusturduk ve "Utils::printInTheSameLineWithSpace" bu ifadeyi yazdık
        }
