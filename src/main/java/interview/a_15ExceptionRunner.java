...
public class a_15ExceptionRunner {
    ...
    public static void getTheNumberOfStudents(int numOfStudents){
        if (numOfStudents<0){
            throw new a_15InvalidNumberException("Ögrenci sayisi ngatif olamaz"); // InvalidNumberException bizim olusturdugumuz yerden cekityorrr
        }else{
    ...
    public static void getStudentGrade(int grade){
        if (grade<0 || grade>100){
            try {
                throw new a_15InvalidStudentGradeException("Notlar 0 dan az olamaz , 100 den büyük olamaz..");
            } catch (a_15InvalidStudentGradeException e) {
